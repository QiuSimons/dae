...
// WriteCloser interface for backward compatibility
type WriteCloser interface {
	CloseWrite() error
}

// Legacy RelayTCP wrapper - since the new version already exists,
// we don't need to redefine it here. The new RelayTCP function
// should be compatible with the old API.
